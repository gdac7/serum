...
class JailbreakStrategy:
    ...
    response_i: str # The Ri used for retrieveal (the strategy achieved a better response from attack_i to attack_j)
    ...
    malicious_request: str = "" # The request being attacked when this was found
    response_j: str = "" # The target's answer to the stronger attempt (pj)
    score_i: Optional[float] = None # The scorer's score for the weaker attempt (pi)
    score_j: Optional[float] = None # The scorer's score for the stronger attempt (pj)
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "response_i": self.response_i,
            "response_j": self.response_j,
            "score_i": self.score_i,
            "score_j": self.score_j,
