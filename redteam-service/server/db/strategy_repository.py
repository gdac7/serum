...
def _to_params(library_id: str, strategy: JailbreakStrategy) -> Dict[str, Any]:
    return {
        ...
        "name": strategy.name,
        "malicious_request": strategy.malicious_request,
        "definition": strategy.definition,
        "example_prompt_pi": strategy.example_prompt_pi,
        "example_prompt_pj": strategy.example_prompt_pj,
        "response_i": strategy.response_i,
        "response_j": strategy.response_j,
        ...
        "score_i": strategy.score_i,
        "score_j": strategy.score_j,
...
def _from_row(row: Dict[str, Any]) -> JailbreakStrategy:
    return JailbreakStrategy(
        ...
        name=row["name"],
        malicious_request=row.get("malicious_request") or "",
        definition=row["definition"] or "",
        example_prompt_pi=row["example_prompt_pi"] or "",
        example_prompt_pj=row["example_prompt_pj"] or "",
        response_i=row["response_i"] or "",
        response_j=row.get("response_j") or "",
        ...
        score_i=row.get("score_i"),
        score_j=row.get("score_j"),
    )
